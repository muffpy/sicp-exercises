...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname multiplication_using_repeatedAddition_ex1.18) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
